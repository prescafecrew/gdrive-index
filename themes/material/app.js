...
function nav(path) {
    ...
    <a href="https://github.com/prescafecrew/gdrive-index" target="_blank" class="mdui-btn mdui-btn-icon mdui-ripple mdui-ripple-white" mdui-tooltip="{content: 'PresCafeCrew - Home'}">
